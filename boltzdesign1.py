...
def run_boltz_design_step(args, config, boltz_model, yaml_dir, main_dir, version_name):
    ...
    boltz_path = '/home/phjiang/.conda/envs/boltz_design/bin/boltz'
...
def run_rosetta_step(args, ligandmpnn_dir, base_pdb_dir, base_pdb_dir_apo):
    ...
    base_pdb_rosetta_success_dir = f"{ligandmpnn_dir}/base_pdb_rosetta_success"
    from pyrosetta_utils import measure_rosetta_energy
    measure_rosetta_energy(
        base_pdb_dir, base_pdb_dir_apo, base_pdb_rosetta_success_dir,
...
def run_pipeline_steps(args, config, boltz_model, yaml_dir, output_dir):
    ...
    results = {'ligandmpnn_dir': f"{output_dir['main_dir']}/{output_dir['version']}/ligandmpnn_cutoff_{args.cutoff}", 
               ...
               'af_pdb_dir': None, 
               'af_pdb_dir_apo': None,
               'base_output_dir': f"{output_dir['main_dir']}/{output_dir['version']}/results_final_pdb", 
               'base_output_apo_dir': f"{output_dir['main_dir']}/{output_dir['version']}/results_final_apo_pdb"}
    ...
    if args.run_alphafold:
        ...
        if args.run_rosetta:
            convert_cif_files_to_pdb(f"{output_dir['main_dir']}/{output_dir['version']}/results_final", results['base_output_dir'])
            convert_cif_files_to_pdb(f"{output_dir['main_dir']}/{output_dir['version']}/results_final_apo", results['base_output_apo_dir'])
            run_rosetta_step(args, results['ligandmpnn_dir'], 
                            results['base_output_dir'], results['base_output_apo_dir'])
